...
if __name__ == "__main__":
    ...
    if args.capture_video:
        eval_envs = RecordEpisode(eval_envs, output_dir=f"runs/{run_name}/videos", save_video=True, save_trajectory=False, max_steps_per_video=args.num_eval_steps, video_fps=30)
